...
/**
  シングルトン.
*/
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) UrcaManager * _Nonnull shared;)
...
/**
  SDK 共通ログの出力フラグを切り替える.
  remark:
  リリース時はコメントアウト、またはfalseを設定してください.
  remark:
  trueでログを出力.
  remark:
  デフォルト = false.
...
/**
  ...
  <ul>
    ...
    <li>
      UITableViewCellを継承していない場合に使用してください.
    </li>
  </ul>
  \param cell 非カスタムセル.
...
/**
  ...
  <ul>
    ...
    <li>
      UITableViewCellを継承している場合に使用してください.
    </li>
  </ul>
